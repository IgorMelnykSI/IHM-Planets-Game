...
public class CarEffects : MonoBehaviour
{
    ...
    public Transform leftWheelTire;
    public Transform rightWheel;
    public Transform rightWheelTire;
    ...
    private void UpdateTurnWheelsEffect()
    {
        ...
        float wheelRotationAngle = carMovement.input.x * 30f; // Adjust the multiplier to change the maximum steering angle
        leftWheel.localRotation = Quaternion.Euler(leftWheel.localRotation.eulerAngles.x, leftWheel.localRotation.eulerAngles.y, wheelRotationAngle);
